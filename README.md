...
[![PyPI](https://img.shields.io/pypi/v/mcp-vet)](https://pypi.org/project/mcp-vet/)
...
pip install "mcp-vet[dynamic]"
```

The PyPI package is `mcp-vet`; the command it installs is `mcp-sentinel`.
